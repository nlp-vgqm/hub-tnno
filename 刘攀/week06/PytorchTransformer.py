...
class PytorchTransformerLayer(nn.Module):
    def __int__(self, vocab_size, segment_size=2, position_size=512):
        super(PytorchTransformerLayer, self).__int__()
...
def test_transformer():
    # 示例调用
    model = PytorchTransformerLayer(vocab_size=30522)  # BERT-base 词汇表大小
