...
print(f'{[len(l) for l in result]}')
# print(result[0])
print(f'{len(centers)}*{len(centers[0])}')
print(distances)
...
for i in range(len(result)):
    ...
    lens_distance.append((i,distances))

lens_distance.sort(key=lambda x:x[1])

for i in lens_distance:
    print(f'点{centers[i[0]]}\n距离:{i[1]}]\n')
