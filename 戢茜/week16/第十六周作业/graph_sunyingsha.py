...
class GraphQA:
    def __init__(self):
        self.graph = Graph("bolt://localhost:7687", auth=("neo4j", "Myth722_gabriel"))
...
if __name__ == "__main__":
    graph = GraphQA()
    res = graph.query("孙颖莎的生日是")
    print(res)
    res = graph.query("孙颖莎第一次获得国家大赛金牌的比赛是")
    print(res)
    res = graph.query("2025年多哈世乒赛女子单打冠军是")
